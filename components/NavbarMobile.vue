<template>
  <ClientOnly >
    <nav data-aos="fade-down" class="flex justify-between text-white p-3 border-b border-gray-500 sticky top-0 z-50 lg:hidden md:hidden backdrop-blur-md">
    ...
    <el-drawer size="90%"  @click="drawer = false"
      style="background: var(--bg-color);color: white; font-size: 20px;" direction="ltr" 
      v-model="drawer" :with-header="true">
      <template #header>
